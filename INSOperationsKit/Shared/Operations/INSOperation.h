...
@property (nonatomic, strong, nonnull, readonly) NSMutableArray <NSObject <INSOperationObserverProtocol> *> *observers;
...
- (void)removeObserver:(nonnull NSObject<INSOperationObserverProtocol> *)observer;
